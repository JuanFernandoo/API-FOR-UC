    ...
    {
        {
            ...
            .AddJwtBearer(options => // Configuración JWT
            {
                ...
                options.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    ValidIssuer = "https://localhost:7230",  // Debe coincidir con el valor del emisor en la emisión del token
                    ValidAudience = "https://localhost:7230", // Debe coincidir con el valor de la audiencia en la emisión del token
